...
local add_files_at = function(index, files)
  index = index - 1
...
local clean_key = function(k)
  k = (' ' .. k .. ' '):gsub('%s+', ' '):sub(2, -2):lower()
  return splitbynum(k)
end

-- compare two strings
local alnumcomp = function(x, y)
...
local find_and_add_entries = function()
